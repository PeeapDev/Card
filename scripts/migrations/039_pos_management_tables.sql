-- Migration: POS Management Tables
-- Description: Create tables for customers, suppliers, discounts, and purchase orders
...
CREATE INDEX IF NOT EXISTS idx_pos_customers_status ON pos_customers(status);
...
CREATE TABLE IF NOT EXISTS pos_suppliers (
    ...
    country VARCHAR(100) DEFAULT 'Sierra Leone',
    tax_id VARCHAR(100),
    payment_terms VARCHAR(50) DEFAULT 'NET30', -- COD, PREPAID, NET15, NET30, NET60, NET90
    credit_limit DECIMAL(15,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS pos_discounts (
    ...
    applies_to VARCHAR(50) DEFAULT 'all', -- all, category, product, customer
...
GRANT ALL ON pos_customers TO service_role;
