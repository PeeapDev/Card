/**
 * Populate POS with Sample Products
 * Run: node scripts/populate-pos-products.js
 */
...
async function populatePOS() {
  console.log('🚀 Starting POS product population...\n');

  try {
    // 1. Find a merchant user
    console.log('1️⃣ Finding merchant user...');
    ...
    console.log('\n✅ POS population complete!');
    console.log(`   📦 Products created: ${totalProducts}`);
    console.log(`   🏪 View in POS: /merchant/pos/products`);
