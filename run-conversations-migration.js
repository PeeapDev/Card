/**
 * Run Conversations Messaging Migration
 */
...
async function runMigration() {
  ...
  const migrationPath = path.join(__dirname, 'scripts/migrations/087_conversations.sql');
  ...
  if (errorCount > 0) {
    ...
    console.log('scripts/migrations/087_conversations.sql');
