...
export function SDKDocsPanel() {
  ...
  const codeExamples: Record<string, string> = {
    javascript: `import { CardPaySDK } from '@cardpay/sdk';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6">
          ...
          <code className="text-sm bg-gray-100 px-3 py-2 rounded block">npm install @cardpay/sdk</code>
        </Card>
...
export function SimulatorPanel() {
  ...
  const handleSimulate = async () => {
    ...
    const newResult: SimulationResult = {
      ...
      request: {
        ...
        amount: parseFloat(authForm.amount) || 0,
      ...
      response: Math.random() > 0.2
        ? {
            ...
            balance: 1000 - (parseFloat(authForm.amount) || 0),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">Transaction Simulator</h2>
          <p className="text-sm text-gray-500">Test card transactions in sandbox environment</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            <h3 className="text-md font-semibold mb-4">Response Codes</h3>
      ...
      {simulationResults.length > 0 && (
        <Card className="overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 className="text-md font-semibold">Simulation History</h3>
            <button
