...
export function WebhooksPage() {
  ...
  const [webhooks] = useState<WebhookEndpoint[]>([
    {
      id: 'wh_001',
      url: 'https://api.example.com/webhooks/cards',
      description: 'Card events webhook',
      events: ['card.created', 'card.updated', 'card.activated', 'card.frozen'],
      status: 'active',
    ...
    },
    {
      ...
      events: ['transaction.created', 'transaction.authorized', 'transaction.cleared', 'transaction.declined'],
      status: 'active',
    ...
    },
    {
      ...
      events: ['customer.created', 'customer.updated', 'customer.kyc.approved', 'customer.kyc.rejected'],
      status: 'failing',
      secret: 'whsec_mno456pqr789stu012',
    ...
    {
      id: 'wh_004',
      url: 'https://api.staging.example.com/webhooks',
      description: 'Staging environment',
      events: ['*'],
      status: 'disabled',
      secret: 'whsec_stg_test123456789',
  ...
  const [deliveries] = useState<WebhookDelivery[]>([
    {
      ...
      duration: 145,
      retries: 0,
      payload: { type: 'card.created', data: { id: 'card_123', last4: '4242' } },
    ...
    },
    {
      ...
      duration: 89,
      retries: 0,
      payload: { type: 'transaction.authorized', data: { id: 'txn_456', amount: 100.00 } },
      response: '{"received": true}',
    },
    {
      id: 'del_003',
      ...
      duration: 5000,
      retries: 3,
      payload: { type: 'customer.kyc.approved', data: { id: 'cust_789' } },
    ...
    },
    {
      ...
      duration: null,
      retries: 2,
      payload: { type: 'card.frozen', data: { id: 'card_999', reason: 'suspicious_activity' } },
