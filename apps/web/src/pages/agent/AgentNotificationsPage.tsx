...
const notificationIcons: Record<string, typeof Bell> = {
  ...
  cashout_completed: DollarSign,
  float_added: Wallet,
  float_low: AlertTriangle,
  customer_served: Users,
...
const typeColors: Record<string, string> = {
  ...
  cashout_completed: 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400',
  float_added: 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400',
  float_low: 'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400',
  customer_served: 'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400',
  commission_earned: 'bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400',
  location_verified: 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400',
    ...
    try {
      ...
      if (error) {
        ...
        setStats({
          ...
          transactions: allData.filter((n) => n.type.includes('transaction') || n.type.includes('cashout')).length,
          commissions: allData.filter((n) => n.type === 'commission_earned').length,
        });
      }
    } catch (error) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Stay updated on your agent activity
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <MotionCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.commissions}</p>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <option value="cashout_completed">Cash Out</option>
                <option value="float_added">Float Added</option>
                <option value="float_low">Float Low</option>
                <option value="commission_earned">Commission</option>
                <option value="customer_served">Customer</option>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
                You'll be notified when there's activity on your agent account
              </p>
            </div>
          ) : (
