...
const typeColors: Record<string, string> = {
  ...
  deposit_completed: 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400',
  withdrawal_completed: 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400',
  payment_failed: 'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400',
  card_activated: 'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400',
  cashback_earned: 'bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400',
    ...
    try {
      ...
      if (error) {
        ...
        setStats({
          ...
          transfers: allData.filter((n) => n.type.includes('transaction')).length,
          security: allData.filter((n) => n.type === 'security' || n.type === 'login').length,
        });
      }
    } catch (error) {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <MotionCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.transfers}</p>
          ...
          <MotionCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.security}</p>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <option value="deposit_completed">Deposit</option>
                <option value="withdrawal_completed">Withdrawal</option>
                <option value="card_activated">Card</option>
                <option value="cashback_earned">Cashback</option>
