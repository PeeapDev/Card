...
class _DepositScreenState extends ConsumerState<DepositScreen> {
  ...
  Future<void> _deposit() async {
    ...
    final success = await notifier.depositMobileMoney(
      ...
      builder: (context) => AlertDialog(
        content: Column(
          ...
          children: [
            ...
            Text(
              'A prompt has been sent to ${_phoneController.text}. Please approve the payment to complete your deposit.',
            ...
            child: Column(
              ...
              children: [
                ...
                AmountTextField(
                  ...
                  validator: (value) =>
                      Validators.amount(value, min: 1000, max: 5000000),
                ),

                const SizedBox(height: 8),

                const Text(
                  'Min: Le 1,000 | Max: Le 5,000,000',
                  style: TextStyle(
